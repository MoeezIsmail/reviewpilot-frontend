const ReviewsSkeleton = () => (
    <div className="flex flex-col gap-4">
        {/* Filter bar */}
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 flex flex-wrap items-center gap-3 animate-pulse">
            <div className="h-9 bg-gray-200 dark:bg-gray-700 rounded-lg w-48" />
            <div className="h-9 bg-gray-200 dark:bg-gray-700 rounded-lg w-32" />
            <div className="h-9 bg-gray-200 dark:bg-gray-700 rounded-lg w-32" />
            <div className="ml-auto h-9 bg-indigo-100 dark:bg-indigo-900/40 rounded-lg w-28" />
        </div>
                ...
                <div key={i} className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-100 dark:border-gray-700 animate-pulse">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            <div className="h-8 w-20 bg-indigo-100 dark:bg-indigo-900/40 rounded-lg" />
