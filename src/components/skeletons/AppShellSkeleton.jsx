const AppShellSkeleton = () => (
    <div className="flex h-screen w-screen bg-gray-100 dark:bg-gray-900">
        {/* Sidebar */}
        <aside className="w-64 h-screen flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 shrink-0">
            <div className="flex p-6 items-center gap-3 border-b border-gray-100 dark:border-gray-700">
                <div className="w-10 h-10 bg-indigo-200 dark:bg-indigo-800 rounded-xl animate-pulse" />
                <div className="h-5 bg-indigo-100 dark:bg-indigo-900 rounded w-28 animate-pulse" />
            </div>
            ...
            <div className="p-4 border-t border-gray-100 dark:border-gray-700">
                <div className="h-11 bg-red-50 dark:bg-red-950/30 rounded-xl animate-pulse" />
            </div>
        </aside>
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
            ...
            <main className="p-4 flex-1 space-y-6 overflow-y-auto bg-gray-100 dark:bg-gray-900">
                {/* Stat cards */}
